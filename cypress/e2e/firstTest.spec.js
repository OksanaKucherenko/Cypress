...
describe('First Test Suite', () => {
    ...
    it('Second test',() =>{
        ...
        // find() - fiond child elements by locator
        // contains() - find HTML test and by text and locator
    ...
    it('extract test value',() =>{
        ...
        cy.get('[for="exampleInputEmail1"]').then( label =>{
            ...
            //4
            cy.get('[for="exampleInputEmail1"]').invoke('attr','class').then(classValue => expect(classValue).to.equal('label'))
        ...
        cy.contains('Toastr').click()
           ...
           it('Date picker',() =>{                  
            ...
            function selectDayFromCurrent(day){
                ...
                console.log('AssertDate' + ' ' + dateToAssert)
            ...
            cy.contains('nb-card','Common Datepicker').find('input').then( input => {
                cy.wrap(input).click()    
                const dateToAssert = selectDayFromCurrent(46)
